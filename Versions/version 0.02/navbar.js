...
// import { getVistaCorrente } from "./month.js";
...
//cose da fare: evitare l'accumulo di invio scrivendo meglio la funzione;

// aggiustare la funzione del cambio mese con i click per adattarla al mese selezionato, magari facendo un po di refactoring
 ...
 monthView.classList.add("show-section");
    ...
    monthBtn.addEventListener("click", function(){
         if (currentState !== 0 && !monthView.classList.contains("show-section")) {
            ...
            currentState = 0;
    } else if ( currentState === 0 && monthView.classList.contains("show-section")){
            return
    }
    })
   ...
   weekBtn.addEventListener("click", function(){
    if (currentState !== 1 && !weekView.classList.contains("show-section")) {
            ...
            OverlayDay.classList.remove("show-display");
            currentState = 1;
    } else if ( currentState === 1 && monthView.classList.contains("show-section")){
            return
    }
    })
    ...
    if (currentState !== 2 && !dayView.classList.contains("show-section")) {
            ...
            currentState = 2;
    } else if ( currentState === 2 && monthView.classList.contains("show-section")){
            return
    }
    })
