...
// const timeLable = document.querySelector(".ul-week-time");
// const weekStructure = document.querySelector(".week-structure");
// const timeLable = document.querySelector(".time-week");
...
export default function createWeekGrid (currentview) {
    ...
    for(let j = 0 ; j < 7; j++){
        ...
        let firstDayOfWeek = currentview.weekday(j + 1);
...
weekGrid.addEventListener("click", highightDay)
